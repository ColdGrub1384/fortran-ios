...
#define ENTFTN_i8(UC, LC) fort_##LC##_i8
#define ENTF90_i8(UC, LC) f90_##LC##_i8
...
(void *ab, OBJECT_DESC *ad, void *bb, OBJECT_DESC *bd, __INT_T flag, ...)
{
  ...
  if (flag) {
    ...
    if (flag & (ARG1_PTR | ARG1_ALLOC)) {
      OBJECT_DESC *vatd = va_arg(va, OBJECT_DESC *);
      if (!((flag & ARG1_PTR) &&
            ENTFTN_i8(ASSOCIATED, associated)(ab, (F90_Desc *)ad, 0, 0)) &&
          !I8(__fort_allocated)(ab)) {
        t1 = vatd;
    ...
    if (flag & (ARG2_PTR | ARG2_ALLOC)) {
      OBJECT_DESC *vatd = va_arg(va, OBJECT_DESC *);
      if (!((flag & ARG2_PTR) &&
            ENTFTN_i8(ASSOCIATED, associated)(bb, (F90_Desc *)bd, 0, 0)) &&
          !I8(__fort_allocated)(bb)) {
        t2 = vatd;
...
void ENTF90(SET_TYPE, set_type)(F90_Desc *dd, OBJECT_DESC *td)
{
  ...
  if (type) {
    td2->type = type;
      if (type == __f03_ty_to_id_i8[__STR]) {
      td2->size = td->size;
    }
  } else {
...
ENTF90(GET_OBJECT_SIZE, get_object_size)(F90_Desc *d)
{
  ...
  td = od->type;
    return td && td != __f03_ty_to_id_i8[__STR] ? td->obj.size : od->size;
}
...
ENTF90(KGET_OBJECT_SIZE, kget_object_size)(F90_Desc *d)
{
  ...
  td = od->type;
    return (__INT8_T)(td && td != __f03_ty_to_id_i8[__STR] ? td->obj.size :
                    od->size);
}
  ...
  if (dest_td) {
    if (ad && ad->tag == __DESC && ad->rank > 0) {
      ...
      *dest_sz = (size_t)dest_td->obj.size * ad->len;
        ...
        *dest_sz = dest_td != __f03_ty_to_id_i8[__STR] ? 
